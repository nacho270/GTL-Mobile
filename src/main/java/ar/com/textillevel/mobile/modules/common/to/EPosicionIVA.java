...
public enum EPosicionIVA {
	...
	RESPONSABLE_INSCRIPTO_AGENTE_RETENCION(4, "Responsable inscripto - Agente de rentenci?n", ETipoFactura.A, "Resp. Insc"),
	EXENTO(5, "Exento", ETipoFactura.B, "Ex."), 
	EXPORTACION(6, "Exportaci?n", ETipoFactura.E, "Exp"),
	EXPORTACION_ARG(7, "Exportaci?n - Argentina", ETipoFactura.E, "Exp - Arg");
