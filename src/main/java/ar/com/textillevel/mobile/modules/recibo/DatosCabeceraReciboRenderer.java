...
public class DatosCabeceraReciboRenderer extends DatosCabeceraRenderer<ReciboMobileTO> {
	...
	public void render(){
		...
		setTextOnTextView(R.id.owner_recibo, "SR/ES: " + getDocument().getCliente().getRazonSocial(),getRootView());
		setTextOnTextView(R.id.owner_recibo_dir,"DIRECCION: " + getDocument().getCliente().getDireccion() + " - " + getDocument().getCliente().getLocalidad(),getRootView());
